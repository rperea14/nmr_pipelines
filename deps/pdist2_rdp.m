function [D,I] = pdist2_rdp(X,Y,dist,varargin)
% COPY OF PDIST2 FROM THE STATS TOOLBOX (DUE TO LICENSE ISSUES< WE DICED TO
...
dflts =  {        []        []  []};
[smallest,largest,radius] = internal.stats.parseArgs(pnames, dflts, varargin{:});
