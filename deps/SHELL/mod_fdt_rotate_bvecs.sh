#!/bin/bash
#Created by Rodrigo Perea (derived from connectome Buckner's  pipeline /cluster/bang/ADRC/Scripts/older/diffusion/adrc_diff_prep/rotate_bvecs )  
#
...
#       ! This script only checks sign changes and doesn't take into account shearing, scaling, rotating orientation (as is not needed for HABs)
