classdef dwi_ADRC < dwiMRI_Session
    ...
    methods
        ...
        function obj = CommonPreProc(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %TOREMOVE:
            %OBSOLETE CODE USED TO CREATED THE PROTECTED METHOD
            %proc_ants_RegSyN() UNDER DWIMRRI_Session
            %
            %             %Now for future methodologies, we normalize the multiple
            %             %diffusion weighted iamge to MNI using ants transformations
            %             obj.Params.ants_dwi2MNI.in.b0_fn = obj.Params.CoRegMultiple.out.combined_b0;
            %             obj.Params.ants_dwi2MNI.in.MNI_tocopy = [ obj.dependencies_dir filesep 'MNI_masks' filesep 'MNI152_T1_2mm_brain.nii.gz' ] ;
            %
            %             %NEED TO CREATE THIS METHODS INSIDE DWIMRI_SESSION AS PROTECTED
            %             %SO OTHERS CAN CALL IT
            %
            %
            %             obj.Params.ants_dwi2MNI.in.output_prefix =  '' %'%'MNI2dwi' %'dwi2MNI';
            %             obj.Params.ants_dwi2MNI.in.movefiles = ['..' filesep '07_ants_dwi2MNI'];
            %
            %             proc_FROIS2dwi();
            %
            %
